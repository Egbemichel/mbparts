...
const PartsClient: React.FC<PartsClientProps> = ({
  categorySlug,
  categoryName = "",
}) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Category Name */}
      <h1 className="text-3xl md:text-left text-center font-bold mb-6">
        {categoryName ||
          categorySlug
            .replace(/-/g, " ")
        ...
        <div className="flex-1 space-y-6">
          {products.map((product) => (
            <React.Fragment key={product.id}>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border p-4 rounded-lg bg-white">
                {/* Image */}
