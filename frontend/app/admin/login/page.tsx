...
export default function LoginPage() {
    ...
    return (
        <div className="w-full max-w-md mx-auto px-4 py-8 sm:px-8 relative">
            ...
            <form onSubmit={onSubmit} className="space-y-6">
                ...
                <button className="w-full bg-black text-white p-3 rounded-md text-base font-semibold" disabled={loading}>Login</button>
            </form>
        </div>
    );
}
